    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserAllergyId = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProfileAllergyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    UserProfileId = table.Column<int>(type: "int", nullable: false),
                    UserAllergyId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileAllergies", x => x.ProfileAllergyId);
                    table.ForeignKey(
                        name: "FK_ProfileAllergies_UserAllergies_UserAllergyId",
                        column: x => x.UserAllergyId,
                        principalTable: "UserAllergies",
                        principalColumn: "UserAllergyId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfileAllergies_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileAllergies_UserAllergyId",
                table: "ProfileAllergies",
                column: "UserAllergyId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileAllergies_UserProfileId",
                table: "ProfileAllergies",
